...
//         public function __construct()
//         {
//             $this->root = $this->find_index_path();
//         }
...
//         public function autoload(string $class)
//         {
//             $opjects = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($this->root));
//             $file = DIRECTORY_SEPARATOR . $this->class_path($class) . '.php';
//             foreach ($opjects as $name => $object) {
//                 if (strpos($name, $file) !== false) {
//                     require_once $name; // inport the requested class
//                 }
//             }
//         }
//     }, 'autoload'
